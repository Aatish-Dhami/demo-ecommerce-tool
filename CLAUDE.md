...
| `@flowtel/shop` | ✅ Functional | Product list, detail, cart, checkout, order confirmation, tracker integration, checkout tracking (checkout_started, purchase_completed events) |
