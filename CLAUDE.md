...
| `@flowtel/shop` | ✅ Functional | Product list, detail, cart (with tracking), checkout (checkout_started, purchase_completed events), order confirmation, tracker integration |
